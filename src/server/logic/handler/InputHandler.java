		 ...
		 ServerOutput oo = new ServerOutput(output,o.getState());
	        if (state == WAITING) {
	        	...
	        	if (input.equalsIgnoreCase("create user")) {
	        		...
	        		output = "What can I do for you?Menu:Create User/Title/Item,Delete User/Title/Item,Monitor";
	                state = CLERK;
	                oo.setOutput(output);
		            oo.setState(state);
	        	}else{
	            	output = "Please select from the menu.Menu:Create User/Title/Item,Delete User/Title/Item,Monitor";
	                state = CLERK;
	                oo.setOutput(output);
		            oo.setState(state);
	            }
